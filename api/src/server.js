...
var pg_1 = require("pg");
var transactions_js_1 = require("./routes/transactions.js");
...
await (0, transactions_js_1.transactionRoutes)(app, pool);
app.get("/health", function () { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, pool.query("SELECT 1")];
            case 1:
                result = _a.sent();
                return [2 /*return*/, { status: "ok", db: result.rows.length === 1 }];
        }
    });
}); });
